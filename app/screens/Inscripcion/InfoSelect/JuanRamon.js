...
export default function JuanRamon (){
...
<Image source={require("../../../../assets/photo_2021-05-17_17-53-21.jpg")}
    style={styles.logo}
/>
    ...
    marginTop:11,
    marginBottom:20,
}]}>Centro Educativo Juan Ramon Nuñez Catillo</Text>
    ...
    <MapView style={styles.map} initialRegion={{latitude:18.53367849271263, longitude:-70.03993634693603, latitudeDelta:0.09, longitudeDelta:0.0921 }}>
<Marker
  coordinate={{ latitude : 18.53367849271263 , longitude : -70.0632116737742 }} title="Juan Ramon"
/>
    </MapView>
